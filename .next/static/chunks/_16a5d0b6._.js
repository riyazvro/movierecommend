            ...
            const getMoviesList = {
                "Page.useEffect.getMoviesList": async ()=>{
                    try {
                        ...
                        setFavorites(Array.isArray(data === null || data === void 0 ? void 0 : data.result) ? data.result : []);
...
_s(Page, "Ztw52dfcURF+F8wmgomQkZAXDDo=");
_c = Page;
...
//# sourceMappingURL=_16a5d0b6._.js.map