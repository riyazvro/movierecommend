...
const Page = () => {
    ...
    useEffect(() => {
        const fetchId = async () => {
            ...
            const raw = JSON.stringify({ "movieid": "hjvd" });
    ...
    const removeFromWatchLater = async () => {
        const myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json");
        const raw = JSON.stringify({ "movieid": show.id });
    ...
    return (
        <div className='w-[80%] max-md:w-full max-md:ml-2 max-md:pr-2 mx-auto '>
            <Toaster />
            ...
            <div className='flex flex-col gap-5'>
                <div className='flex justify-center gap-2'>
                    ...
                    <h1 className="text-4xl animate-pulse border-[#f84565] rounded-2xl border-b border-2  max-md:ml-5 w-[320px] px-3 py-2 ">Movie Of The Day</h1>
                </div>
                    ...
                    {trailer?.key ? (
                        <div className='relative w-full pb-[56.25%]'>
                            <ReactPlayer
                                ...
                                muted={false}
                                loop={false}
                                config={{ youtube: { playerVars: { modestbranding: 1, controls: 1, rel: 0 } } }}
                            />
                        </div>
                    ) : (
                        <div className="text-center py-8 text-gray-500">
